...
def main(env, eos=False):
    ...
    html = f"""<table>
            ...
            <tr>
                ...
                <td style="text-align:left">{int(hourly_goal_dict['MC1'])}</td>
                <td style="text-align:center">{mc1_df_count:.1f}</td>
                <td style="text-align:center">---</td>
                <td style="text-align:center">---</td>
                <td style="text-align:center">---</td>
            </tr>
            <tr>
                ...
                <td style="text-align:left">{int(hourly_goal_dict['MC2'])}</td>
                <td style="text-align:center">{mc2_df_count:.1f}</td>
                <td style="text-align:center">{mc2_df_performance:.1f}</td>
                <td style="text-align:center">{mc2_df_badpart:.1f}</td>
                <td style="text-align:center">{mc2_df_notready:.1f}</td>
            </tr>
            <tr>
