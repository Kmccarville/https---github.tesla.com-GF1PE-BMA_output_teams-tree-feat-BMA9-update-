...
def main(env,eos=False):
    ...
    if eos:
        cta_html = '<table>' + header_html +cta2_html + cta3_html + cta4_html + cta4_yield_html + cta5_html + cta5_yield_html + cta6_html + cta6_yield_html + cta8_html + cta8_yield_html + zone1_combined + '</table>'
    else:
        cta_html = '<table>' + header_html + cta2_html + cta3_html + cta4_html + cta5_html + cta6_html + cta8_html + zone1_combined + '</table>'
