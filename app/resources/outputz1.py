...
def cta_records(lookback,cta3,cta4,cta5,cta8,webhook):
    ...
    line5 = cta5
    line8 = cta8
    names = ['ACTA3','CTA4','CTA5','CTA8']
    carsets = [line3,line4,line5,line8]
    newRecordArray = []
    prevShiftArray = []
    prevDateArray = []
    prevRecordArray = []
...
def main(env,eos=False):
    ...
    cta_records(lookback,cta3,cta4,cta5,cta8,webhook)
